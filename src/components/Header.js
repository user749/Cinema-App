...
export const Header = () => {
  ...
  return (
    <header>
    <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
      <Link to="/" className="flex items-center">
          <img src="https://flowbite.com/docs/images/logo.svg" className="h-6 mr-3 sm:h-9" alt="Cinema Logo" />
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Cinema Base</span>
      </Link>

      <div id="mobile-nav" className="flex md:order-2">
      
        {/*add the moon and sun icon*/} 
