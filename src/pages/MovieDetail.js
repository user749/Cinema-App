...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie() {
      const response  = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=ffb2df65ea8c1708d71c7cf6d65e7eb9`);
            ...
            <p className="my-4">
             ...
             <p className="my-4">
              <span className="mr-2 font-bold">IMBD Code:</span>
                <a href={`https://www.imdb.com/title/${movie.imdb_id}`} target="_blank" rel="noreferrer">IMDB Page</a>
             </p>
        </div>
      </section>
    </main>
